  ...
  return (
    <aside className='d-none d-sm-block sidebar bg-linear-3 vh-100 overflow-y-auto position-sticky top-0'>
        <div className='sidebar-logo icon-link p-lg-4 p-3'>
            ...
            <h2 className="logo ms-2 text-light d-none d-lg-block">Akademi</h2>
        </div>
        ...
        <div className="sidebar-footer ms-3 mt-5">
            <small className="text-light fs-small fw-bold d-none d-lg-inline">Akademi - School Admin <br/> Dashboard</small>
            <small className="text-light d-none d-lg-block">Made with <span><HeartFill className="text-danger"/></span> by Peterdraw</small>
        </div>
    </aside>
  )
}
