                    ...
                    <div className='flex-grow-1' style={{ minWidth: 0 }}>
                        <div className='bg-light p-4 rounded-4 position-relative pb-lg-5 overflow-hidden '>
                            ...
                            <div className="d-flex flex-wrap gap-4">
                                <div className="d-flex flex-column flex-fill" style={{ minWidth: "250px" }}>
                                    <p className="text-gray-400 sidebar-link">Parent:</p>
                                    <div className="d-flex align-items-center gap-lg-3 gap-2 fw-medium">
                                        <div className="flex-shrink-0 bg-info text-light p-3 rounded-circle contact-icon position-relative">
                                            <Person
                                                size={24}
                                ...
                                <div className="d-flex flex-column flex-fill" style={{ minWidth: "250px" }}>
                                    ...
                                    <div className="d-flex align-items-center gap-lg-3 gap-2 fw-medium">
                                        ...
                                        <span className="text-break">{studentData.email}</span>
                                    </div>
                                </div>
                            </div>
