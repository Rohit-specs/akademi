        ...
        <div className="m-lg-4 m-3">
            ...
            <main className="p-4 bg-light rounded-4">
                <div className="w-100 px-2 px-md-3 py-3">
                    {data.map((section) => (
                        <div key={section.date} className="mb-5">
                            <h6 className="fw-bold mb-4">{section.date}</h6>
                            ...
                            {section.items.map((item) => (
                                ...
                                >
                                    ...
                                    <p className="mb-2 small">
                                        {item.user && <strong>{item.user}</strong>} {item.action}{" "}
                                        <span className={`fw-semibold text-${item.color}`}>
                                            {item.target}
                                        </span>{" "}
                                        {item.extra}
                                    </p>
